	...
	var MobileMenu = function () {
		...
		_createClass(MobileMenu, [{
			...
			value: function events() {
				this.menuIcon.click(this.toggleTheMenu.bind(this)); //bind to switch back to original element in this, otherwise this is the button element itself
			}
		}, {
			key: "toggleTheMenu",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RevealOnScroll = function () {
		function RevealOnScroll(els, offset) {
			...
			this.offsetPercentage = offset; // property
			this.hideInitially(); // method call
